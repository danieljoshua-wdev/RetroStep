...
import otherBrands from "../data/otherBrands";
...
function OtherBrands() {
  ...
  const sortedProducts = [...otherBrands].sort((a, b) => {
  ...
  return (
    <div className="px-6 py-10 max-w-[1400px] mx-auto">
      <Breadcrumbs path="Home / Shop / Other Brands" />
      <CategoryTitle title="Other Brands" />
