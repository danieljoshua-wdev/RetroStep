...
import onitsukaTiger from "../data/onitsukaTiger";

function OnitsukaTiger() {
  ...
  const sortedProducts = [...onitsukaTiger].sort((a, b) => {
  ...
  return (
    <div className="px-6 py-10 max-w-[1400px] mx-auto">
      <Breadcrumbs path="Home / Shop / Onitsuka Tiger" />
      <CategoryTitle title="Onitsuka Tiger" />
