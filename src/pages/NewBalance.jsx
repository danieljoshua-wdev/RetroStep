...
import newBalance from "../data/newBalance";
function NewBalance() {
  ...
  const sortedProducts = [...newBalance].sort((a, b) => {
  ...
  return (
    <div className="px-6 py-10 max-w-[1400px] mx-auto">
      <Breadcrumbs path="Home / Shop / New Balance" />
      <CategoryTitle title="New Balance" />
