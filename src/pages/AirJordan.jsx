...
import airJordan from "../data/airJordan";
...
function AirJordan() {
  ...
  const sortedProducts = [...airJordan].sort((a, b) => {
  ...
  return (
    <div className="px-6 py-10 max-w-[1400px] mx-auto">
      <Breadcrumbs path="Home / Shop / Air Jordan" />
      <CategoryTitle title="Air Jordan" />
