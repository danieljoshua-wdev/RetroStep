// src/pages/CollectiblesLabubu.jsx
...
import collectiblesLabubu from "../data/collectiblesLabubu";

function CollectiblesLabubu() {
  ...
  // SORT
  const sortedProducts = [...collectiblesLabubu].sort((a, b) => {
  ...
  return (
    <div className="px-6 py-10 max-w-[1400px] mx-auto">
      <Breadcrumbs path="Home / Shop / Collectibles / Labubu" />
      <CategoryTitle title="Collectibles / Labubu" />
...
export default CollectiblesLabubu;
